"""
Django settings for emzcl project.
...
SECRET_KEY = 'django-insecure-w_t-l71)6th(5-rty(dru4d)v)zmoxz(nz3&qfh-4b2mbj_a#5'
...
REST_FRAMWORK = {
    'EXCEPTION_HANDLER':'emzcl.Helpers.custom_exception_handler'
}
...
WSGI_APPLICATION = 'emzcl.wsgi.application'
