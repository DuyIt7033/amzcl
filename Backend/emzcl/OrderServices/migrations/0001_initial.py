    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'DRAFT'), ('SENT', 'SENT'), ('RECEIVED', 'RECEIVED'), ('PARTIAL RECEIVED', 'PARTIAL RECEIVED'), ('CANCELLED', 'CANCELLED'), ('RETURNED', 'RETURNED'), ('PARTIAL DELIVERED', 'PARTIAL DELIVERED')], default='DRAFT', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.CharField(choices=[('PERCENTAGE', 'PERCENTAGE'), ('AMOUNT', 'AMOUNT')], default='PERCENTAGE', max_length=255)),
                ('additional_details', models.JSONField()),
                ('status', models.CharField(choices=[('DRAFT', 'DRAFT'), ('SENT', 'SENT'), ('DELIVERED', 'DELIVERED'), ('PARTIAL DELIVERED', 'PARTIAL DELIVERED'), ('CANCELLED', 'CANCELLED'), ('RETURNED', 'RETURNED'), ('PARTIAL DELIVERED', 'PARTIAL DELIVERED')], default='DRAFT', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('approve_at', models.DateTimeField()),
                ('cancelled_at', models.DateTimeField()),
